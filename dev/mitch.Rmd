...
if ( d==1 ) {
    message("Quadrant/sector distribution does not apply to unidimensional analysis.")
} else if {
...
```{r,tauchart1q,results="asis",echo=F, fig.height = 7, fig.width = 7 ,fig.show="all", message=FALSE}
library("taucharts")
library(dplyr)
library(gtools)
