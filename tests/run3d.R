...
rna<-read.table(system.file("extdata/rna.tsv", package = "mitch"),header=T)
k9a<-read.table(system.file("extdata/k9a.tsv", package = "mitch"),header=T)
k36a<-read.table(system.file("extdata/k36a.tsv", package = "mitch"),header=T)
